# -*- coding: utf-8 -*-
"""
Created on Wed Nov 11 13:40:48 2020
...
signals6, fields6 = wfdb.io.rdsamp('drive06')
...
train_in, val_in, train_out, val_out = train_test_split(trainData, trainLabels, test_size = 0.2)
...
signals7, fields7 = wfdb.io.rdsamp("drive07")
...
train_in, val_in, train_out, val_out = train_test_split(trainData_scale, trainLabels, test_size = 0.2)
